...
export const salesApi = {
  ...
  async getOrders(params?: QueryParams & { 
    ...
    return ApiService.get<PaginatedResponse<SalesOrder>>('/v1/sales-orders', { params })
  },

  async getOrder(id: string) {
    return ApiService.get<SalesOrder>(`/v1/sales-orders/${id}`)
  },

  async getOrderByNumber(orderNumber: string) {
    return ApiService.get<SalesOrder>(`/v1/sales-orders/number/${orderNumber}`)
  },

  async createOrder(orderData: Partial<SalesOrder>) {
    return ApiService.post<SalesOrder>('/v1/sales-orders', orderData)
  },

  async updateOrder(id: string, orderData: Partial<SalesOrder>) {
    return ApiService.put<SalesOrder>(`/v1/sales-orders/${id}`, orderData)
  },

  async deleteOrder(id: string) {
    return ApiService.delete(`/v1/sales-orders/${id}`)
  },

  async confirmOrder(id: string) {
    return ApiService.put<SalesOrder>(`/v1/sales-orders/${id}/confirm`)
  },

  async shipOrder(id: string, data: { trackingNumber?: string; shippingMethod?: string; notes?: string }) {
    return ApiService.put<SalesOrder>(`/v1/sales-orders/${id}/ship`, data)
  },

  async deliverOrder(id: string) {
    return ApiService.put<SalesOrder>(`/v1/sales-orders/${id}/deliver`)
  },

  async completeOrder(id: string) {
    return ApiService.put<SalesOrder>(`/v1/sales-orders/${id}/complete`)
  },

  async cancelOrder(id: string, reason?: string) {
    return ApiService.put<SalesOrder>(`/v1/sales-orders/${id}/cancel`, { reason })
  },

  async duplicateOrder(id: string) {
    return ApiService.post<SalesOrder>(`/v1/sales-orders/${id}/duplicate`)
  },

  async getOrderSummaries() {
    return ApiService.get('/v1/sales-orders/summary')
  },

  async getDashboardStats() {
    return ApiService.get('/v1/sales-orders/dashboard-stats')
  },

  async getFulfillmentStatus(id: string) {
    return ApiService.get(`/v1/sales-orders/${id}/fulfillment-status`)
  },

  async getOrdersByCustomer(customerId: string, limit?: number) {
    return ApiService.get(`/v1/sales-orders/customer/${customerId}`, { params: { limit } })
  },

  async getOrderInvoices(id: string) {
    return ApiService.get(`/v1/sales-orders/${id}/invoices`)
  },

  async createInvoiceFromOrder(id: string) {
    return ApiService.post(`/v1/sales-orders/${id}/create-invoice`)
  },
