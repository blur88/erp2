      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Box sx={{ mt: 3, p: 2, bgcolor: 'info.lighter', borderRadius: 1 }}>
          ...
          >
            ...
            The document title automatically adjusts based on the document type (e.g., "Sales
            Order", "Invoice", etc.). You can customize headers and footers in the General tab.
          </Typography>
        </Box>
      </Paper>
      {/* Preview Dialog */}
      <Dialog open={previewOpen} onClose={handleClosePreview} maxWidth="md" fullWidth>
        <DialogTitle>{selectedTemplate?.title} Template Preview</DialogTitle>
        <DialogContent>
          {selectedTemplate && <TemplatePreview template={selectedTemplate} settings={settings} />}
        </DialogContent>
        <DialogActions>
