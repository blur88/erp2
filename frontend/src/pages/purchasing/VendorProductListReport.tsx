...
import { default as ProductIcon } from '@mui/icons-material/Business'
...
const VendorProductListReport: React.FC = () => {
  ...
  const [reportData, setReportData] = useState<VendorProductList[]>([])
  ...
  const [reportTitle, setReportTitle] = useState<string>('Vendor Product List Report')
                  ...
                  {loading ? (
                    ...
                    <>
                      ...
                      <Typography variant="body2" sx={{
                        ...
                        Configure the filters on the left and click "Generate Report" to view vendor product list.
                      </Typography>
                    </>
                  )}
                </Box>
