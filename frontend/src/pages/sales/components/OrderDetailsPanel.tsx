            ...
            <TableContainer>
              ...
              >
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell sx={{ fontWeight: TYPOGRAPHY_STYLES.tableCell.primary.fontWeight, color: 'text.secondary', fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>SO Date</TableCell>
                    <TableCell sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>{formatDate(selectedOrder.orderDate)}</TableCell>
                  </TableRow>
                  <TableRow sx={{ backgroundColor: 'grey.50' }}>
                    <TableCell sx={{ fontWeight: TYPOGRAPHY_STYLES.tableCell.primary.fontWeight, color: 'text.secondary', fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>Invoice No</TableCell>
                    <TableCell sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>
                      {selectedOrder.invoices && selectedOrder.invoices.length > 0 ? (
                        ...
                        <Typography sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize, color: 'text.secondary', fontStyle: 'italic' }}>
                  ...
                  <TableRow>
                    <TableCell sx={{ fontWeight: TYPOGRAPHY_STYLES.tableCell.primary.fontWeight, color: 'text.secondary', fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>Payment No</TableCell>
                    <TableCell sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>
                  ...
                  <TableRow sx={{ backgroundColor: 'grey.50' }}>
                    ...
                    <TableCell sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>
                      {!selectedOrder.isFulfilled ? (
                        <Typography sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize, color: 'text.secondary', fontStyle: 'italic' }}>Not fulfilled</Typography>
                      ) : journalEntryRefLoading ? (
              ...
              >
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>{formatCurrency((selectedOrder as any).shippingAmount || 0)}</TableCell>
                  </TableRow>
                  <TableRow sx={{ backgroundColor: 'grey.50' }}>
                  ...
                  <TableRow sx={{ backgroundColor: 'grey.50' }}>
                    ...
                    <TableCell sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize }}>{balance < 0 ? `-${formatCurrency(Math.abs(balance))}` : formatCurrency(balance)}</TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableBody>
                    {selectedOrder.items.map((item: any, index: number) => (
                      <TableRow key={index} hover sx={{ '&:hover': { backgroundColor: 'action.hover' }, transition: 'background-color 0.2s ease', height: TABLE_STYLES.row.height }}>
                        ...
                        <TableCell align="center" sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.secondary.fontSize, fontWeight: TYPOGRAPHY_STYLES.tableCell.secondary.fontWeight, lineHeight: TYPOGRAPHY_STYLES.tableCell.secondary.lineHeight }}>
                          {item.quantity || 0}
                        </TableCell>
                        <TableCell align="right" sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.secondary.fontSize, fontWeight: TYPOGRAPHY_STYLES.tableCell.secondary.fontWeight, lineHeight: TYPOGRAPHY_STYLES.tableCell.secondary.lineHeight }}>
                        ...
                        <TableCell align="right" sx={{ fontSize: TYPOGRAPHY_STYLES.tableCell.primary.fontSize, lineHeight: TYPOGRAPHY_STYLES.tableCell.primary.lineHeight }}>
