...
const SalesOrderPrintDialog: React.FC<SalesOrderPrintDialogProps> = ({
  ...
  const renderSalesOrderContent = () => {
    ...
    const recipient = {
      ...
      address: salesOrder.customer?.shippingStreetAddress || salesOrder.customer?.billingStreetAddress || '',
      ...
      postalCode: salesOrder.customer?.shippingPostalCode || salesOrder.customer?.billingPostalCode || '',
