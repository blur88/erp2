...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      "Register new user account. Auto-login after successful registration.",
  })
  ...
  async shouldShowDefaultCredentials(): Promise<{
    showDefaultCredentials: boolean;
  }> {
    const showDefaultCredentials =
      await this.authService.shouldShowDefaultCredentials();
