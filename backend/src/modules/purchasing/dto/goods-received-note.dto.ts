...
export class CreateGoodsReceivedNoteDto {
  ...
  @ApiPropertyOptional({
    description:
      "GRN items (optional - will be auto-generated from PO if not provided)",
...
export class UpdateGoodsReceivedNoteDto extends PartialType(
...
export class GoodsReceivedNoteQueryDto {
  ...
  @ApiPropertyOptional({
    description: "Search term (GRN number, PO number, supplier)",
  })
  @IsOptional()
  @IsString()
  search?: string;
