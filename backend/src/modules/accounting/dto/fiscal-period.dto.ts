...
export class CreateFiscalPeriodDto {
  @ApiProperty({
    description: 'Unique period code (e.g., "2026-01", "Q1-2026")',
    maxLength: 50,
  })
  @IsString()
  @MaxLength(50)
...
export class QueryFiscalPeriodsDto {
  ...
  @ApiPropertyOptional({
    ...
    enum: ["code", "name", "startDate", "createdAt"],
  })
  @IsOptional()
  @IsString()
  sortBy?: string;
...
export class GenerateFiscalPeriodsDto {
  ...
  @ApiPropertyOptional({
    description: "Start month (1-12, default: 1)",
    minimum: 1,
    maximum: 12,
    default: 1,
  })
...
export class FiscalPeriodValidationResponseDto {
  ...
  @ApiPropertyOptional({
    description: "Matched fiscal period",
    type: FiscalPeriodResponseDto,
  })
