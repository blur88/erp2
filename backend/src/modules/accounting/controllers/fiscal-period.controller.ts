...
export class FiscalPeriodController {
  ...
  @ApiResponse({
    status: 409,
    description:
      "Period code already exists or dates overlap with existing period",
  })
  async create(
    ...
    return this.fiscalPeriodService.create(
      createDto,
      currentUserId,
      currentUsername,
    );
  ...
  async update(
    ...
    return this.fiscalPeriodService.update(
      id,
      updateDto,
      currentUserId,
      currentUsername,
  ...
  @ApiResponse({
    status: 409,
    description: "Period code now used by another period",
  })
  async restore(
    @Param("id") id: string,
    @CurrentUser("userId") currentUserId: string,
  ...
  async generatePeriods(
    ...
    return this.fiscalPeriodService.generateFiscalPeriods(
      dto,
      currentUserId,
      currentUsername,
    );
  ...
  async closePeriod(
    ...
    return this.fiscalPeriodService.closePeriod(
      id,
      currentUserId,
      currentUsername,
    );
  ...
  async reopenPeriod(
    ...
    return this.fiscalPeriodService.reopenPeriod(
      id,
      currentUserId,
      currentUsername,
    );
