...
export class SettlementController {
  ...
  @Get("pending-summary")
  @ApiOperation({
    summary: "Get pending settlement summary grouped by payment method",
  })
  ...
  @ApiOperation({
    summary: "Get pending payments for settlement by payment method",
  })
  ...
  async permanentDelete(
    ...
    return this.settlementService.permanentDelete(
      id,
      currentUserId,
      currentUsername,
    );
