...
export class CreateStockMovementDto {
  ...
  @ApiProperty({
    description:
      "Movement quantity (positive for inward, negative for outward)",
  })
  ...
  @ApiPropertyOptional({
    description: "Reference type (sales_order, purchase_order, etc.)",
  })
  @IsOptional()
  @IsString()
  @MaxLength(50)
...
export class QueryStockMovementsDto {
  ...
  @ApiPropertyOptional({
    ...
    enum: ["movementDate", "quantity", "totalValue"],
  })
  @IsOptional()
  @IsString()
  sortBy?: string;
...
export class StockReservationDto {
  ...
  @ApiPropertyOptional({
    description: "Expiry date for reservation (auto-release after this date)",
  })
  @IsOptional()
  @Transform(({ value }) => (value ? new Date(value) : undefined))
  @IsDate()
