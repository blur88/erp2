...
export class QueryCategoriesDto extends BaseQueryDto {
  ...
  @ApiPropertyOptional({
    description: "Include full tree structure (nested children)",
    default: false,
  })
  @IsOptional()
  @Transform(({ value }) => {
...
export class CategoryResponseDto {
  ...
  @ApiPropertyOptional({
    description: "Child categories (when includeTree is true)",
...
export class CategoryTreeResponseDto {
  @ApiProperty({
    description: "Tree structure of categories",
    type: [CategoryResponseDto],
  })
  data: CategoryResponseDto[];
...
export class CategoryAncestorsDto {
  ...
  @ApiProperty({
    description: "List of ancestor categories from root to parent",
    type: [CategoryResponseDto],
  })
...
class CategoryPathUpdateDto {
  ...
  @ApiProperty({
    description:
      "Force path recalculation for this category and all its descendants",
    default: false,
  })
  @IsOptional()
  @IsBoolean()
