...
export class StockAdjustmentItemDto {
  ...
  @ApiProperty({
    description:
      "Stock snapshot at adjustment time; can be negative (e.g. oversell)",
  })
...
export class QueryStockAdjustmentsDto {
  ...
  @ApiPropertyOptional({
    description: "Search term (adjustment number, notes)",
  })
  @IsOptional()
  @IsString()
  search?: string;
  ...
  @ApiPropertyOptional({
    ...
    enum: ["adjustmentDate", "adjustmentNumber", "totalValue", "itemCount"],
  })
  @IsOptional()
  @IsString()
  sortBy?: string;
...
export class StockAdjustmentResponseDto {
  ...
  @ApiProperty({
    description: "Adjustment items",
    type: [StockAdjustmentItemResponseDto],
  })
