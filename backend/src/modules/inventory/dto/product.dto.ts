...
export class CreateProductDto {
  ...
  @ApiPropertyOptional({
    description: "Product barcode - unique product identifier",
    maxLength: 100,
  })
  @IsOptional()
  @IsString()
...
export class ProductResponseDto {
  ...
  @ApiPropertyOptional({
    description: "Deletion date (only for soft-deleted products)",
  })
  deletedAt?: Date;
}
...
export class BulkUpdatePricesDto {
  @ApiProperty({
    description: "List of product IDs and their new prices",
    type: "array",
  })
  @IsArray()
  @ArrayMinSize(1)
...
export class ProductImportDto {
  ...
  @ApiPropertyOptional({
    description: "Skip duplicate products",
    default: false,
  })
  @IsOptional()
