...
describe("PaymentService", () => {
  ...
  let settingsService: jest.Mocked<
    Pick<SettingsService, "generateDocumentNumber">
  >;
  ...
  beforeEach(async () => {
    ...
    (settingsService.generateDocumentNumber as jest.Mock).mockResolvedValue(
      "PAY-26-001",
    );
  });
  ...
  describe("create", () => {
    ...
    it("should load payment with relations before posting", async () => {
      ...
      const callArg =
        accountingService.postCustomerPaymentEntry.mock.calls[0][0];
