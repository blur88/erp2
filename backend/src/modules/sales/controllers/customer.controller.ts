...
export class CustomerController {
  ...
  @ApiResponse({
    status: 400,
    description:
      "Cannot delete customer with active orders, invoices, or other dependencies",
    schema: {
      type: "object",
      properties: {
        message: {
          type: "string",
          example:
            "Cannot delete customer 'John Doe' because they have 3 orders and 2 invoices.",
        },
        error: {
          type: "string",
  ...
  @ApiResponse({
    status: 400,
    description:
      "Customer must be soft-deleted first or has active dependencies",
    schema: {
      type: "object",
      properties: {
        message: {
  ...
  async permanentDelete(
    ...
    await this.customerService.permanentDelete(
      id,
      currentUserId,
      currentUsername,
    );
