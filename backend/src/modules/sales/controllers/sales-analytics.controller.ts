...
export class SalesAnalyticsController {
  ...
  @ApiOperation({
    summary:
      "Get customer payment by order report - shows payments grouped by sales order",
  })
  @ApiQuery({
    name: "dateFrom",
    required: false,
  ...
  @ApiOperation({
    summary:
      "Get customer payment details report - shows individual payment transactions",
  })
  @ApiQuery({
    name: "dateFrom",
    required: false,
  ...
  @ApiOperation({
    summary:
      "Get customer order history report - shows order line items with product details",
  })
  @ApiQuery({
    name: "dateFrom",
    required: false,
  ...
  @ApiOperation({
    summary:
      "Get product-customer report - shows which customers purchased which products",
  })
  @ApiQuery({
    name: "dateFrom",
    required: false,
