...
export class BackupRetentionSettings extends BaseEntity {
  @Column({
    type: "int",
    default: 30,
    comment: "Number of days to retain backups before auto-cleanup (max 365)",
  })
  ...
  @Column({
    ...
    nullable: true,
    comment:
      "Maximum total size of all backups in bytes (null for unlimited, max 104857600 bytes = 100MB)",
  })
