...
export class MigrateLegacyPricingToTiers1733227200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Step 2: Migrate existing legacy pricing data to pricingTiers
    ...
    // Step 3: For products with empty pricingTiers but valid legacy prices, populate them
    await queryRunner.query(`
      UPDATE "products"
      SET "pricingTiers" = jsonb_build_object(
        'Retail', COALESCE("retailPrice", 0),
    ...
    // Step 4: Remove legacy pricing columns
